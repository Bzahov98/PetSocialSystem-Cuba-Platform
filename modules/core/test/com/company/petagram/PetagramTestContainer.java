...
public class PetagramTestContainer extends TestContainer {

    public PetagramTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/petagram/app.properties",
    ...
    public static class Common extends PetagramTestContainer {

        public static final PetagramTestContainer.Common INSTANCE = new PetagramTestContainer.Common();
